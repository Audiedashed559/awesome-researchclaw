...
3. Under Assets, look for a Windows download file.
...
1. Open the app or project list.
2. Start with a research goal.
3. Pick one tool for search, one for writing, and one for workflow tracking.
4. Test each tool on a small task first.
5. Keep the tools that fit your work style.
